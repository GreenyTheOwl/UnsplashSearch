...
//  RMR_test
//
//  Created by Павел Духовенко on 28.02.2021.
//

import Foundation
import UIKit

protocol PaginationControlDelegate: class {
    func refreshAll(completion: @escaping (Bool) -> Void)
    func loadMore(completion: @escaping (Bool) -> Void)
}

class PaginationControl: NSObject {
    ...
    weak var delegate: PaginationControlDelegate?
